...
Enemy.prototype.update = function(dt) {
	...
	if (player.x < this.x + 50 && player.x + 40 > this.x && player.y < this.y + 35 && player.y + 40 > this.y) {
...
Player.prototype.update = function() {
	...
	//One point added to heart total when player reaches top of canvas popup modal appears when total equals 10
	if (this.y <= 0) {
		this.x = 200;
		this.y = 400;
		score++;
